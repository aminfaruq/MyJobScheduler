package com.example.maminfaruq.myjobscheduler;
...
public class GetCurrentWeatherJobService extends JobService {
    ...
    final String APP_ID = "da8c851ca7a8d0a4788be9aa02ffa6ea";

    final String CITY = "Samarinda";
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    String descripton = responseObject.getJSONArray("weather")
                    ...
                    String message = currentWeather + ", " + descripton + " with " + temprature +
                            " celcius";
    ...
    private void showNotification(Context context, String title, String message, int notifId) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context,CHANNEL_ID)
                ...
                .setSmallIcon(R.mipmap.ic_replay_30_black_24dp)
